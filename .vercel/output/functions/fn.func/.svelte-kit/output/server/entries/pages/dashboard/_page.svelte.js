import { c as create_ssr_component, f as add_attribute, a as compute_rest_props, i as createEventDispatcher, v as validate_component, j as escape, s as setContext, h as compute_slots, k as getContext, b as spread, e as escape_attribute_value, d as escape_object, g as subscribe } from "../../../chunks/ssr.js";
import { a as authLogin } from "../../../chunks/client.js";
import "../../../chunks/index.js";
import { i as is_void, S as Section, B as Button } from "../../../chunks/Button.js";
import * as dom from "@floating-ui/dom";
import { twJoin, twMerge } from "tailwind-merge";
import { F as Frame } from "../../../chunks/Frame.js";
import { w as writable } from "../../../chunks/exports.js";
import { W as Wrapper } from "../../../chunks/Wrapper.js";
const SidebarBottomNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
const SidebarBottomNavItem = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { href = "" } = $$props;
  let { tooltip = "" } = $$props;
  ...
  return `<a${add_attribute("href", href, 0)}${add_attribute("class", aClass, 0)}>${slots.default ? slots.default({}) : ``}</a> ${tooltip ? `${validate_component(Tooltip, "Tooltip").$$render($$result, { arrow: false }, {}, {
    default: () => {
    ...
    {},
    {
      default: () => {
        return `${validate_component(Sidebar, "Sidebar").$$render(
          $$result,
          {
            class: "overflow-auto justify-between max-h-screen"
          },
          {},
          {
            default: () => {
              return `${validate_component(SidebarWrapper, "SidebarWrapper").$$render($$result, { class: "bg-white" }, {}, {
                default: () => {
                  return `${validate_component(SidebarGroup, "SidebarGroup").$$render($$result, {}, {}, {
                    default: () => {
                      return `${validate_component(SidebarItem, "SidebarItem").$$render($$result, { label: "Inicio" }, {}, {
                        icon: () => {
                      ...
                      })} ${validate_component(SidebarDropdownWrapper, "SidebarDropdownWrapper").$$render($$result, { label: "Registros" }, {}, {
                        icon: () => {
                        ...
                        default: () => {
                          return `${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Categorias", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Medidas", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Insumos", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Productos", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Proveedores", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Empleados", href: "/" }, {}, {})}`;
                        }
                      })} ${validate_component(SidebarDropdownWrapper, "SidebarDropdownWrapper").$$render($$result, { label: "Sales" }, {}, {
                        icon: () => {
                          return `<svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"></path></svg> `;
                        },
                        default: () => {
                          return `${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Products", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Billing", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Invoice", href: "/" }, {}, {})}`;
                        }
                      })} ${validate_component(SidebarItem, "SidebarItem").$$render($$result, { label: "Messages", href: "/", spanClass }, {}, {
                        subtext: () => {
                          return `<span class="inline-flex justify-center items-center p-3 ml-3 w-3 h-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full dark:bg-blue-400 dark:text-gray-900" data-svelte-h="svelte-1rxwrro">6</span> `;
                        },
                        icon: () => {
                      ...
                      })} ${validate_component(SidebarDropdownWrapper, "SidebarDropdownWrapper").$$render($$result, { label: "Authentication" }, {}, {
                        icon: () => {
                        ...
                        default: () => {
                          return `${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Sign In", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Sign Up", href: "/" }, {}, {})} ${validate_component(SidebarDropdownItem, "SidebarDropdownItem").$$render($$result, { label: "Forgot Password", href: "/" }, {}, {})}`;
                        }
                      })}`;
                    }
                  })} ${validate_component(SidebarGroup, "SidebarGroup").$$render($$result, { border: true }, {}, {
                    default: () => {
                      return `${validate_component(SidebarItem, "SidebarItem").$$render($$result, { label: "Docs", spanClass }, {}, {
                        icon: () => {
                      ...
                      )} ${validate_component(SidebarItem, "SidebarItem").$$render($$result, { label: "Help", href: "/" }, {}, {
                        icon: () => {
                  ...
                  })} ${validate_component(SidebarGroup, "SidebarGroup").$$render($$result, { class: "relative pt-64" }, {}, {
                    default: () => {
                      return `${validate_component(SidebarBottomNav, "SidebarBottomNav").$$render($$result, {}, {}, {
                        default: () => {
                          return `${validate_component(SidebarBottomNavItem, "SidebarBottomNavItem").$$render($$result, { href: "/", tooltip: "Profile" }, {}, {
                            default: () => {
                          ...
                          })} ${validate_component(SidebarBottomNavItem, "SidebarBottomNavItem").$$render($$result, { href: "/", tooltip: "Settings page" }, {}, {
                            default: () => {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_user();
  return `<main>${$user ? `${validate_component(Dashboard, "Dashboard").$$render($$result, {}, {}, {})}` : ``}</main>`;
});
export {
  Page as default
};
