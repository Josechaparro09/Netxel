<script lang="ts">
  ...
  <Section
    name="tableheader"
    sectionClass="bg-gray-50 dark:bg-gray-900 flex h-full py-4"
  >
    <Sidebar class="overflow-auto justify-between max-h-screen">
      <SidebarWrapper class="bg-white">
        <SidebarGroup>
          ...
          <SidebarDropdownWrapper label="Registros">
            ...
            <SidebarDropdownItem label="Insumos" href="/" />
            <SidebarDropdownItem label="Productos" href="/" />
            <SidebarDropdownItem label="Proveedores" href="/" />
            <SidebarDropdownItem label="Empleados" href="/" />
          </SidebarDropdownWrapper>
